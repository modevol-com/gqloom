...
`weave` 函数可以接收[解析器](../fundamentals-features/resolver)、[丝线](../fundamentals-features/silk)、编织器配置、全局[中间件](../fundamentals-features/middleware)
...
有时候，我们需要将一个单独的[丝线](../fundamentals-features/silk)编织到 GraphQL Schema 中，例如：
...
```
在[中间件章节](../fundamentals-features/middleware)中查看更多关于中间件的用法。