...
<Tabs groupId='zod-version' items={['zod-v4', 'zod-v3']}>
<Tab value='zod-v4'>

```sh tab="npm"
npm i @gqloom/core zod@next @gqloom/zod@next
```
```sh tab="pnpm"
pnpm add @gqloom/core zod@next @gqloom/zod@next
```
```sh tab="yarn"
yarn add @gqloom/core zod@next @gqloom/zod@next
```
```sh tab="bun"
bun add @gqloom/core zod@next @gqloom/zod@next
```
