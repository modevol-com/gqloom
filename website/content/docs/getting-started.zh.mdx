...
```ts title="src/resolvers/index.ts" tab="src/resolvers/index.ts"
import { query, resolver } from "@gqloom/core"
import { z } from "zod"
...
很好，现在让我们在演练场尝试一下：
```gql title="GraphQL Mutation" tab="GraphQL Mutation"
mutation {
...
继续尝试找回刚刚创建的用户：
```gql title="GraphQL Query" tab="GraphQL Query"
{
...
```ts twoslash title="src/resolver/user.ts"
// @filename: schema/index.ts
import { drizzleSilk } from "@gqloom/drizzle"
import { relations } from "drizzle-orm"
import * as t from "drizzle-orm/sqlite-core"
...
```ts twoslash title="src/resolvers/cat.ts" tab="src/resolvers/cat.ts"
// @filename: schema/index.ts
import { drizzleSilk } from "@gqloom/drizzle"
import { relations } from "drizzle-orm"
import * as t from "drizzle-orm/sqlite-core"
