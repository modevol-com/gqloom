<template>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" :class="props.class" view-box="0 0 360 360">
    <path fill="#3068B7" fill-rule="evenodd"
    ...
    <path fill="#FBBF24" fill-rule="evenodd"
